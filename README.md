...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p eecdff63-47c6-4980-847f-7dd6ac290820
```

> `eecdff63-47c6-4980-847f-7dd6ac290820` is the password of the certificate, you can change it to any password you want.
